    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <a class="brand" href="index.html">Админпанель</a>
                <div class="nav-collapse">
                    <ul class="nav pull-right">
                        ...
                        if(Yii::$app->user->isGuest) {
                            echo "<li>";
                            echo Html::a(Yii::t('app',"{icon} SignIn",['icon'=>FA::icon('sign-in')]), Url::toRoute('site/login'), ['class' => 'btn btn-success',]);
                            echo "</li>";
                        }
                        else
                        {
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <i class="icon-cog"></i> Кабинет <b class="caret"></b>
                                </a>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <i  class="icon-user"></i>Партком<b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:;">Профиль</a></li>
                                    <li><a href="javascript:;" class="js-exit">Выход</a></li>
                                </ul>
                            </li>
                        <?php } ?>
                    </ul>
        ...
        <div class="subnavbar-inner">
            <div class="container">
                <ul class="mainnav">
                    ...
                    <li class="active"><a href="index.html"><i class="icon-dashboard"></i><span>Главная</span> </a> </li>
                    <li><a href="reports.html"><i class="icon-list-alt"></i><span>Отчеты</span> </a> </li>
