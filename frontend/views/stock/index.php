    		...
    		<div class="col-md-8  col-lg-8">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<hr>
						<?= $form->field($model, 'save_format')->checkbox(['class'=>'ch','label'=>'Использовать сохраненный порядок колонок']) ?><br/>
						<?= $form->field($model, 'delete_content')->checkbox(['class'=>'ch','label'=>'С удалением старых данных']) ?>
